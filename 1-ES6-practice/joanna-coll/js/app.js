...
function displayPics(){
  ...
  // Let variable is a block-scope variable, so it can be called or reassigned inside displayBlock function. In this case console.log called variable outide the function it is defined under.
  console.log(viewed);
